...
fn use_and_drop(s: String) -> String {
    println!("I used your variable '{s}', lol!");
    println!();
...
fn borrow_and_use(s: &String) -> String {
    println!("I borrowed your variable '{s}', sir.");
    println!();
    let dummy = String::from("lol");
    dummy
}
